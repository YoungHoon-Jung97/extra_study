...
<script type="text/javascript">		
	$(function(){
	    $(".btn-success").click(function(){
	        ...
	        if(sub1=="" || sub2=="" ||sub3==""){
	        	$("#errMsg").text("필수 정보를 입력하세요.").css("display", "inline");
	            return;
	        }
						...
						<tr> 
							<td>
								<div class="input-group" role="group">
									...
									placeholder="sid" maxlength="30" value="${sid}" readonly="readonly"
									/>
									<span class="input-group-addon">입력 불가</span>
								</div>
							</td>
						</tr>
		             	...
		             	<tr>
		                	<td>
		                    	<div class="input-group" role="group">
		                              ...
		                              국어 점수 <sup style="color: red;">※</sup>
		                          	</span>
		                           	<input type="number" id="sub1" name="sub1" class="form-control"
		                           	placeholder="국어 점수" maxlength="30" required="required"
		                           	min="0" max="100"/>
						...
						<tr style="height: 10px;"></tr>
		             	...
		             	<tr>
		                	<td>
		                    	<div class="input-group" role="group">
		                       		<span class="input-group-addon" id="basic-addon2">
		                              수학 점수 <sup style="color: red;">※</sup>
		                          	</span>
		                           	<input type="number" id="sub2" name="sub2" class="form-control"
		                           	placeholder="수학점수" maxlength="30" required="required"
		                           	min="0" max="100"/>
		                           	<span class="input-group-addon"> 0~100 점 </span>
		                    	</div>
		                	</td>                  
		             	...
		             	<tr>
		                	<td>
		                    	<div class="input-group" role="group">
		                       		<span class="input-group-addon" id="basic-addon2">
		                              영어 점수 <sup style="color: red;">※</sup>
		                          	</span>
		                           	<input type="number" id="sub3" name="sub3" class="form-control"
		                           	placeholder="영어점수" maxlength="30" required="required"
		                           	min="0" max="100"/>
		                           	<span class="input-group-addon"> 0~100 점 </span>
		                    	</div>
		                	</td>                  
